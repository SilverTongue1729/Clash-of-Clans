...
from characters import spawnBarbarian, move_barbarians, spawnArcher, move_archers, spawnDragon, move_dragons, spawnBalloon, move_balloons, spawnHealer, move_healers, clearTroops
...
while(True):
    ...
    # elif ch == 't':
    #     spawnSneakyArcher(V.spawn_points[0])
    # elif ch == 'y':
    #     spawnSneakyArcher(V.spawn_points[1])
    # elif ch == 'u':
    #     spawnSneakyArcher(V.spawn_points[2])
    elif ch == 'm':
    ...
    move_dragons(V)
    move_balloons(V)
    # move_sneakyarchers(V,pt.movement)
    move_healers(King,V)
